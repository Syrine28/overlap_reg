...
def sweep_and_compare(tex1, tex2, crop1, crop2) :
    ...
    return cv2.imshow('/Users/syrineenneifer/Desktop/best_overlap00', best_overlap1), cv2.imshow('/Users/syrineenneifer/Desktop/best_overlap01', best_overlap2) #or just min_overlap1
...
img1 = cv2.imread("/Users/syrineenneifer/Desktop/oak_back_00_heightmap_nrm.png")
...
img2 = cv2.imread("/Users/syrineenneifer/Desktop/oak_back_00_heightmap_nrm.png")
